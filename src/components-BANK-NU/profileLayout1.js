      ...
      <Box mt={{ base: 4, md: 0 }} ml={{ md: 6 }}>
        ...
        <List spacing={3}>
          <ListItem>
            ...
            MetaGame provides value and service supporting the fourth industrial
        ...
        <UnorderedList>
          <ListItem> MetaGame Lesson1 </ListItem>
          <ListItem> MetaGame Lesson2 </ListItem>
          <ListItem> MetaGame Lesson3 </ListItem>
          <ListItem> MetaGame Lesson4 </ListItem>
        </UnorderedList>
        <br />
        <OrderedList>
          <ListItem> MetaGame Lesson5 </ListItem>
          <ListItem> MetaGame Lesson6 </ListItem>
          <ListItem> MetaGame Lesson7 </ListItem>
          <ListItem> MetaGame Lesson8 </ListItem>
        </OrderedList>
        <br />
        <br />
        <Stat>
