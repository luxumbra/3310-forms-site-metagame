...
{                
     ...
     content: (       
        <>    
        <StatsText> MetaGame  </StatsText> in North America has chosen MetaGame for Competitive Analysis 
</>               
),
},
{                
     ...
     content: (       
        <>    
        <StatsText> MetaGame  </StatsText> currently connected and monitored by MetaGame Applications 
</>               
),
},
];
