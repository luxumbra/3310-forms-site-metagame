...
{title}    
      ...
      function Testimonial1() {      
       return (     
        ...
        <Heading color="gray.900" > MetaGame Clients  </Heading>  
<Text color="gray.900" > Three MetaGame provides value and service supporting the fourth industrial revolution. Web3 is a set of technologies that publicly interoperate through blockchain and node based computing systems. </Text>  
        </Stack>    
        <Stack    
