...
<Text>{props.date.toLocaleDateString()}</Text>    
    ...
    const Blog3 = () => {        
       return (     
        ...
        <Heading as="h1"> MetaGame provides Full-Stack MetaGame </Heading>  
        <Box    
...
<Link textDecoration="none" _hover={{ textDecoration: "none" }}>    
MetaGame and MetaGame Provides Metaverse Services part 3   
        </Link>    
        </Heading>    
...
/>
        ...
        <Heading as="h2"> MetaGame provides Full-Stack MetaGame </Heading>  
